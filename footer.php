<footer class="bg-gray-lighter flex text-gray-dark min-h-1/2 tracking-wide">
        <div class="grid w-full lg:flex mx-auto px-8 py-14 gap-8">
            <div class="flex w-full lg:w-1/2 xl:w-1/2">
                ...
                <div class="flex flex-col w-full sm:w-1/2 xl:w-1/2 justify-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/QIP_ACC.png" alt="" class="w-64 lg:mx-auto">
                </div>
            </div>            
            <div class="grid gap-8 sm:flex lg:w-1/2 xl:w-1/2">
                <div class="flex flex-col w-full sm:w-1/2 xl:w-1/2">
                    <?php wp_nav_menu([
                        'menu' => 'Footer Menu1',
